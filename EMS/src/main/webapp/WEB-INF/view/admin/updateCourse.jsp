        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/updateCourse" id="updateCourseForm" method="post">
...
<script type="text/javascript">
    ...
    for (var i = 0;i < deptSelect.length;i++){
        if (deptSelect[i].value == '${course.deptID}'){
