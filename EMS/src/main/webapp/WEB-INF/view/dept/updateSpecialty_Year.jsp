        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        <h1 style="text-align: center">修改年级专业</h1>
                    </div>
                </div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/dept/addSpecialty_Year" id="addSpecialty_YearForm" method="post" onsubmit="return check()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control" name="admissionDate" id="admissionDate" value="<fmt:formatDate value="${specialtyYear.admissionDate}" dateStyle="medium" pattern="yyyy-MM-dd"></fmt:formatDate>">
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    for (var i = 0;i < specialtySelect.length;i++){
        if (specialtySelect[i].value == ${specialtyYear.specialty}){
