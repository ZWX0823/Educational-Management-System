            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <form class="bs-example bs-example-form col-md-7" style="margin: 20px 0 10px 0;" action="${pageContext.request.contextPath}/dept/searchCurriculum" id="searchCurriculumForm" method="post">
