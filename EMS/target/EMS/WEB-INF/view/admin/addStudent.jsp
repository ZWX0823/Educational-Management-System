        ...
        <div class="col-md-10">
            <div class="panel panel-default">
                ...
                <div class="panel-body body">
                    <form class="form-horizontal" role="form" action="${pageContext.request.contextPath}/admin/addStudent" id="addStudentForm" method="post" onsubmit="return check()">
                        ...
                        <div class="form-group" style="text-align: center">
                            ...
                            <input type="hidden" id="message" value="${flag}">
                        </div>
                    </form>
                </div>
            </div>
